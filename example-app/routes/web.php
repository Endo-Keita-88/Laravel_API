...
//会員登録を途中でやめた際にレコードを削除する
Route::get('/verify', [RegisterController::class, 'delete'])->name('delete');

//メール認証処理を行う
Route::get('/register', [RegisterController::class, 'tokenCheck'])->name('tokenCheck');
...
Route::get('/resetCheck', [LoginController::class, 'resetMailCheck'])->name('resetMailCheck');

//パスワード再設定画面(パスワードを忘れた場合)にメール認証処理をする
Route::get('/resetTokenCheck', [LoginController::class, 'resetTokenCheck'])->name('resetTokenCheck');
